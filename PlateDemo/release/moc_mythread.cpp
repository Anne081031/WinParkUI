...
**
** Created: Mon Sep 19 11:08:08 2011
...
static const char qt_meta_stringdata_CMyThread[] = {
    "CMyThread\0"
};

const QMetaObject CMyThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CMyThread,
      qt_meta_data_CMyThread, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CMyThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CMyThread))

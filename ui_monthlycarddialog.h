...
public:
    ...
    void setupUi(QDialog *CMonthlyCardDialog)
    {
        ...
        chkEnter = new QCheckBox(CMonthlyCardDialog);
        chkEnter->setObjectName(QString::fromUtf8("chkEnter"));
        chkEnter->setGeometry(QRect(40, 152, 111, 16));
        chkLeave = new QCheckBox(CMonthlyCardDialog);
        chkLeave->setObjectName(QString::fromUtf8("chkLeave"));
        chkLeave->setGeometry(QRect(190, 152, 101, 16));

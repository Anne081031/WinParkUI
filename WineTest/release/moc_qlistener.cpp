...
**
** Created: Wed Aug 15 18:33:24 2012
...
void QListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QListener *_t = static_cast<QListener *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QListener::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QListener::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QListener,
      qt_meta_data_QListener, &staticMetaObjectExtraData }
};

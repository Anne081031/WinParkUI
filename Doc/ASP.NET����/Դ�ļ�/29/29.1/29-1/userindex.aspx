<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userindex.aspx.cs" Inherits="_29_1.userindex" %>
    ...
    AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" AllowPaging="True" 
                            ...
                            <Columns>
                                <asp:HyperLinkField DataNavigateUrlFields="id" 
                                    DataNavigateUrlFormatString="Show.aspx?id={0}" DataTextField="title" 
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT * FROM [diary] WHERE ([userid] = @userid)">
                            <SelectParameters>

...
struct qt_meta_stringdata_AddUserDialog_t {
    QByteArrayData data[4];
    char stringdata[55];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_AddUserDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_AddUserDialog_t qt_meta_stringdata_AddUserDialog = {
    {
...
QT_MOC_LITERAL(3, 33, 20)
    ...
    "AddUserDialog\0on_ptnAdd_clicked\0\0"
...
const QMetaObject AddUserDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddUserDialog.data,
      qt_meta_data_AddUserDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddUserDialog.stringdata))

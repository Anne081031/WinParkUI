...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NetworkController_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 38, 9)
    ...
    "NetworkController\0Log\0\0strLog\0bStatic\0"
    "HandleLog\0"
};
...
void NetworkController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NetworkController::*_t)(QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkController::Log)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject NetworkController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetworkController.data,
      qt_meta_data_NetworkController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetworkController.stringdata))
...
// SIGNAL 0
void NetworkController::Log(QString _t1, bool _t2)
{

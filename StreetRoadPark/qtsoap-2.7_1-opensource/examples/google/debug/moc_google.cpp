...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Google_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 22, 11)
    ...
    "Google\0submitRequest\0\0getResponse\0"
};
...
void Google::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Google *_t = static_cast<Google *>(_o);
        switch (_id) {
        case 0: _t->submitRequest(); break;
...
const QMetaObject Google::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Google.data,
      qt_meta_data_Google,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Google.stringdata))

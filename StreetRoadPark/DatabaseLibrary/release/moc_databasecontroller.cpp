...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DatabaseController_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 39, 9)
    ...
    "DatabaseController\0Log\0\0strLog\0bStatic\0"
    "HandleLog\0"
};
...
void DatabaseController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DatabaseController::*_t)(QString , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DatabaseController::Log)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DatabaseController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DatabaseController.data,
      qt_meta_data_DatabaseController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DatabaseController.stringdata))
...
// SIGNAL 0
void DatabaseController::Log(QString _t1, bool _t2)
{

/********************************************************************************
** Form generated from reading UI file 'newbatchsetcardaccess.ui'
**
** Created: Tue Sep 3 13:48:56 2013
**      by: Qt User Interface Compiler version 4.7.4
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_NEWBATCHSETCARDACCESS_H
#define UI_NEWBATCHSETCARDACCESS_H
...
class Ui_NewCBatchSetCardAccess
{
public:
    QWidget *widget;
    QWidget *widget_2;
    ...
    void setupUi(QFrame *NewCBatchSetCardAccess)
    {
        if (NewCBatchSetCardAccess->objectName().isEmpty())
            NewCBatchSetCardAccess->setObjectName(QString::fromUtf8("NewCBatchSetCardAccess"));
        NewCBatchSetCardAccess->resize(1320, 685);
        NewCBatchSetCardAccess->setStyleSheet(QString::fromUtf8("background-image:url(D:/WinParkUI/debug/Image/NewIcon/CommonBigBG-normal1366x768.jpg);"));
        NewCBatchSetCardAccess->setFrameShape(QFrame::StyledPanel);
        NewCBatchSetCardAccess->setFrameShadow(QFrame::Raised);
        widget = new QWidget(NewCBatchSetCardAccess);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(40, 50, 1231, 631));
        widget->setStyleSheet(QString::fromUtf8("background-image:url(none);"));
        widget_2 = new QWidget(widget);
        widget_2->setObjectName(QString::fromUtf8("widget_2"));
        widget_2->setGeometry(QRect(920, 0, 301, 551));
        ...
        tableBatchChannel->setGeometry(QRect(10, 0, 281, 391));
        tableBatchChannel->setStyleSheet(QString::fromUtf8("background-image:url(none);"));
        groupBox = new QGroupBox(widget_2);
        groupBox->setObjectName(QString::fromUtf8("groupBox"));
        groupBox->setGeometry(QRect(10, 400, 281, 141));
        ...
        tableWidget->setGeometry(QRect(0, -20, 911, 571));
        ...
        tableBatchMonth->setGeometry(QRect(10, 10, 881, 521));
        ...
        widget_3->setGeometry(QRect(210, 570, 401, 31));
        ...
        btnOk->setGeometry(QRect(1060, 570, 75, 23));
        btnOk->setStyleSheet(QString::fromUtf8("background-image:url(none);"));
        lblTitle = new QLabel(NewCBatchSetCardAccess);
...
"color: rgb(170, 0, 0);"));
        lblClose = new QLabel(NewCBatchSetCardAccess);
        lblClose->setObjectName(QString::fromUtf8("lblClose"));
        lblClose->setGeometry(QRect(1281, 5, 30, 15));

        retranslateUi(NewCBatchSetCardAccess);

        tableWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(NewCBatchSetCardAccess);
    } // setupUi

    void retranslateUi(QFrame *NewCBatchSetCardAccess)
    {
        NewCBatchSetCardAccess->setWindowTitle(QApplication::translate("NewCBatchSetCardAccess", "\346\211\271\351\207\217\350\256\276\347\275\256\345\215\241\347\211\207\350\277\233\345\207\272\346\235\203", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem = tableBatchChannel->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("NewCBatchSetCardAccess", "\351\200\232\351\201\223\345\220\215\347\247\260", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem1 = tableBatchChannel->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("NewCBatchSetCardAccess", "id", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem2 = tableBatchChannel->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("NewCBatchSetCardAccess", "\351\200\211\346\213\251", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("NewCBatchSetCardAccess", "\346\227\266\351\227\264\346\256\265\350\256\276\347\275\256", 0, QApplication::UnicodeUTF8));
        timeStart->setDisplayFormat(QApplication::translate("NewCBatchSetCardAccess", "HH:mm:ss", 0, QApplication::UnicodeUTF8));
        timeEnd->setDisplayFormat(QApplication::translate("NewCBatchSetCardAccess", "HH:mm:ss", 0, QApplication::UnicodeUTF8));
        btnAllTime->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\205\250\346\227\266\346\256\265", 0, QApplication::UnicodeUTF8));
        btnForbidden->setText(QApplication::translate("NewCBatchSetCardAccess", "\347\246\201\346\255\242\351\200\232\350\277\207", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("NewCBatchSetCardAccess", "\350\265\267\345\247\213\357\274\232", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("NewCBatchSetCardAccess", "\347\273\210\346\255\242\357\274\232", 0, QApplication::UnicodeUTF8));
        btnAllUnselected_2->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\205\250\345\217\226\346\266\210", 0, QApplication::UnicodeUTF8));
        btnAllSecleted_2->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\205\250\351\200\211\344\270\255", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = tableBatchMonth->horizontalHeaderItem(0);
        ___qtablewidgetitem3->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\215\241\345\217\267", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = tableBatchMonth->horizontalHeaderItem(1);
        ___qtablewidgetitem4->setText(QApplication::translate("NewCBatchSetCardAccess", "\350\207\252\347\274\226\345\217\267", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = tableBatchMonth->horizontalHeaderItem(2);
        ___qtablewidgetitem5->setText(QApplication::translate("NewCBatchSetCardAccess", "\347\224\250\346\210\267\345\220\215", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem6 = tableBatchMonth->horizontalHeaderItem(3);
        ___qtablewidgetitem6->setText(QApplication::translate("NewCBatchSetCardAccess", "\351\200\211\346\213\251", 0, QApplication::UnicodeUTF8));
        tableWidget->setTabText(tableWidget->indexOf(tab), QApplication::translate("NewCBatchSetCardAccess", "\346\234\210\347\247\237\345\215\241", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem7 = tableBatchTime->horizontalHeaderItem(0);
        ___qtablewidgetitem7->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\215\241\345\217\267", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem8 = tableBatchTime->horizontalHeaderItem(1);
        ___qtablewidgetitem8->setText(QApplication::translate("NewCBatchSetCardAccess", "\350\207\252\347\274\226\345\217\267", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem9 = tableBatchTime->horizontalHeaderItem(2);
        ___qtablewidgetitem9->setText(QApplication::translate("NewCBatchSetCardAccess", "\347\224\250\346\210\267\345\220\215", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem10 = tableBatchTime->horizontalHeaderItem(3);
        ___qtablewidgetitem10->setText(QApplication::translate("NewCBatchSetCardAccess", "\351\200\211\346\213\251", 0, QApplication::UnicodeUTF8));
        tableWidget->setTabText(tableWidget->indexOf(tab_3), QApplication::translate("NewCBatchSetCardAccess", "\350\256\241\346\227\266\345\215\241", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem11 = tableBatchValue->horizontalHeaderItem(0);
        ___qtablewidgetitem11->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\215\241\345\217\267", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem12 = tableBatchValue->horizontalHeaderItem(1);
        ___qtablewidgetitem12->setText(QApplication::translate("NewCBatchSetCardAccess", "\350\207\252\347\274\226\345\217\267", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem13 = tableBatchValue->horizontalHeaderItem(2);
        ___qtablewidgetitem13->setText(QApplication::translate("NewCBatchSetCardAccess", "\347\224\250\346\210\267\345\220\215", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem14 = tableBatchValue->horizontalHeaderItem(3);
        ___qtablewidgetitem14->setText(QApplication::translate("NewCBatchSetCardAccess", "\351\200\211\346\213\251", 0, QApplication::UnicodeUTF8));
        tableWidget->setTabText(tableWidget->indexOf(tab_2), QApplication::translate("NewCBatchSetCardAccess", "\345\202\250\345\200\274\345\215\241", 0, QApplication::UnicodeUTF8));
        btnAllUnselected->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\205\250\345\217\226\346\266\210", 0, QApplication::UnicodeUTF8));
        btnAllSecleted->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\205\250\351\200\211\344\270\255", 0, QApplication::UnicodeUTF8));
        btnMinimalize->setText(QApplication::translate("NewCBatchSetCardAccess", "\345\205\263\351\227\255", 0, QApplication::UnicodeUTF8));
        btnSerach->setText(QApplication::translate("NewCBatchSetCardAccess", "\346\237\245\346\211\276", 0, QApplication::UnicodeUTF8));
        btnOk->setText(QApplication::translate("NewCBatchSetCardAccess", "\347\241\256\350\256\244\344\277\256\346\224\271", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class NewCBatchSetCardAccess: public Ui_NewCBatchSetCardAccess {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NEWBATCHSETCARDACCESS_H

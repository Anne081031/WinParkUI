...
**
** Created: Fri Jan 25 16:26:24 2013
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QMyThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 25, 14)
    ...
    "QMyThread\0ThreadStarted\0\0ThreadFinished\0"
};
...
void QMyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QMyThread *_t = static_cast<QMyThread *>(_o);
        switch (_id) {
...
const QMetaObject QMyThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QMyThread.data,
      qt_meta_data_QMyThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMyThread.stringdata))
        return static_cast<void*>(const_cast< QMyThread*>(this));

...
**
** Created: Wed Jan 23 15:55:16 2013
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setGeometry(QRect(150, 20, 75, 23));
        edtLog = new QPlainTextEdit(centralWidget);
        edtLog->setObjectName(QStringLiteral("edtLog"));
        edtLog->setGeometry(QRect(40, 70, 671, 371));
        MainWindow->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(MainWindow);
        menuBar->setObjectName(QStringLiteral("menuBar"));
        menuBar->setGeometry(QRect(0, 0, 725, 19));

...
**
** Created: Wed Jan 23 11:14:01 2013
...
struct qt_meta_stringdata_QMyTcpServer_t {
    QByteArrayData data[5];
    char stringdata[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_QMyTcpServer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_QMyTcpServer_t qt_meta_stringdata_QMyTcpServer = {
    {
...
QT_MOC_LITERAL(4, 29, 16)
    ...
    "QMyTcpServer\0Accept\0\0qintptr\0"
    "socketDescriptor\0"
};
...
void QMyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QMyTcpServer::*_t)(qintptr );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMyTcpServer::Accept)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QMyTcpServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_QMyTcpServer.data,
      qt_meta_data_QMyTcpServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMyTcpServer.stringdata))
...
// SIGNAL 0
void QMyTcpServer::Accept(qintptr _t1)
{

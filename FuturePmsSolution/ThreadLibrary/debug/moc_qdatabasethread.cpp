...
**
** Created: Fri Jun 29 13:20:36 2012
...
static const char qt_meta_stringdata_QDatabaseThread[] = {
    "QDatabaseThread\0"
};
...
const QMetaObjectExtraData QDatabaseThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QDatabaseThread::staticMetaObject = {
    { &QMyBaseThread::staticMetaObject, qt_meta_stringdata_QDatabaseThread,
      qt_meta_data_QDatabaseThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QDatabaseThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDatabaseThread))

...
**
** Created: Tue Jul 24 13:32:58 2012
...
const QMetaObjectExtraData QMyTcpSocket::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QMyTcpSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_QMyTcpSocket,
      qt_meta_data_QMyTcpSocket, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QMyTcpSocket::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMyTcpSocket))
